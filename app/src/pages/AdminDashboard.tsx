...
import {
  ...
  LogOut, Bell, TrendingUp, ChevronRight,
      ...
      <aside style={{
        ...
        <div style={{ padding: '24px 20px', borderBottom: '1px solid var(--border)' }}>
          ...
          <div style={{
            ...
            background: 'rgba(42,63,224,0.15)', borderRadius: '6px',
            display: 'inline-block',
          }}>
            <span style={{ fontSize: '11px', fontFamily: 'var(--font-mono)', color: 'var(--accent-glow)', fontWeight: 600 }}>
              ADMIN
            </span>
          </div>
        </div>
        ...
        <nav style={{ flex: 1, padding: '16px 12px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
          {[
            ...
            <button key={item.label} style={{
              ...
              background: item.active ? 'rgba(42,63,224,0.15)' : 'transparent',
              color: item.active ? 'var(--accent-glow)' : 'var(--text-secondary)',
      ...
      <main style={{ marginLeft: '240px', padding: '32px', minHeight: '100vh' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '32px' }}>
          ...
          <button style={{
            ...
            boxShadow: '0 4px 16px rgba(42,63,224,0.3)',
          }}>
        ...
        {/* Coming soon banner */}
        <div style={{
          background: 'rgba(42,63,224,0.08)',
          border: '1px dashed rgba(90,108,255,0.3)',
          borderRadius: '16px',
          padding: '48px',
          textAlign: 'center',
        }}>
          <div style={{
            ...
            <LayoutDashboard size={24} color="var(--accent-glow)" />
          </div>
